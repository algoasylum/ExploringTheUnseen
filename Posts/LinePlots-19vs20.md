...
In the previous posts, we looked at a pollution levels in 2019 [here](efef) and 2020 [here](efef) for major cities in India. In this post tie both of them together and try to assess the impact that Lockdown had on air pollution relative to 2019. Have a peek at [Pollution Description](./Pollutants Description.md) for a detailed description of pollutants, their acceptable limits and their health problems associated with them.
...
Looks like PM10 data for Chennai is missing. For Banglore, Chennai and Hyderabad, January to March, the overall trends overlap quiet a bit but as we approach April i.e Lockdown phase the two lines begin to diverge, look at Banglore PM2.5 for reference, indicating the effect of Lockdown, though the margins close. However PM2.5 for Delhi and Mumbai for '19 and '20 appears to be somewhat similar. 
...
Our data seems to suggest only relatively small reduction in pollutant levels were observed compared to last year. We do not know for certain. This begs the question whether this small reduction had such postive impact and if so what a significant drop in overall pollution would look like!
